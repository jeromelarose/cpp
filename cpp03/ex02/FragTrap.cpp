...
//-----------------------------------------------------------------
    ...
    FragTrap::FragTrap() : m_VaultAttackDamage(0)
    {
        ClapTrap::m_HitPoints = 100;
        ClapTrap::m_MaxHitPoints = 100;
        ClapTrap::m_RangedAttackDamage = 20;
        ClapTrap::m_ArmorDamageReduction = 5;
        ...
        std::cout << std::setiosflags(std::ios::left) << "\033[31mJE SUIS LE CONSTRUCTEUR FRAGTRAP\033[37m" << std::endl;
    }

    FragTrap::FragTrap(std::string name) : ClapTrap(100, 100, 100, 100, 1, name, 30, 20, 5), m_VaultAttackDamage(0)
    {
        m_tabFcnt[0] = &FragTrap::sing;
        m_tabFcnt[1] = &FragTrap::dragon;
        m_tabFcnt[2] = &FragTrap::surpise;
...
//-----------------------------------------------------------------
    ...
    FragTrap::~FragTrap()
    {
        std::cout << "\033[31mJE SUIS LE DESTRUCTEUR FRAGTRAP\033[37m" << std::endl;
    }
...
//-----------------------------------------------------------------
    ...
    void FragTrap::beRepaired(unsigned int amount)
    {
        if (m_HitPoints == m_MaxHitPoints)
            std::cout << std::setw(15) << m_Name << ": Il faut vraiment etre un sacree con pour reprendre de la vie quand on est deja au MAX!!!" << std::endl;
        else
        {
            m_HitPoints += amount;
            if (m_HitPoints > m_MaxHitPoints)
